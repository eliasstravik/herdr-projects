...
When you finish, and whenever you stop to wait for the user, write your report to the report path given at the end of this brief. Put files meant for the user (documents, exports, screenshots) in the library folder given there.
